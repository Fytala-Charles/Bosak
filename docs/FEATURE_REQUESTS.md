...
> **Living Registry** — Last updated: 2026-08-20 (XSLT code lens now supports a default source document via `<?bosak source-document="..."?>`; `.xsl` and `.xslt` files show a "Run XSLT transformation" lens, with the source file name shown when the hint is present; language-server tests pass 61/0; unit tests pass 1,731/0; QT3 29,929/0/1,892)
