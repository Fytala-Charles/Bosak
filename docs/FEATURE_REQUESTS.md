...
> **Living Registry** — Last updated: 2026-08-20 (XSLT code lens added to `CodeLensHandler`; `.xsl` and `.xslt` files show a "Run XSLT transformation" lens that invokes `bosak.transformXslt`; language-server tests pass 60/0; unit tests pass 1,731/0; QT3 29,929/0/1,892)
