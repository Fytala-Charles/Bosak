...
#### Acceptance Criteria
- [ ] `json-to-xml-016` through `json-to-xml-047` pass.
- [ ] `fn:json-to-xml` non-validation tests continue to pass.
- [ ] Schema-validation errors raise `FOJS0003` or `FOJS0005` as specified.
