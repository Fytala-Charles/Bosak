...
> **Bosak baseline:** 1,777 unit tests passed / 0 failed / 0 skipped
> **QT3 baseline:** **30,831 passed / 68 failed / 922 skipped** (96.89%). Targeted **`prod-OrderByClause`**: 205 passed / 0 failed / 0 skipped. The residual decimal-normalization failures (`orderBy26/36/46/56/62/64/65`) are fixed by `VmEngine.TryCast` returning the atomized typed value for `xs:T($node)` casts on schema-validated nodes.
