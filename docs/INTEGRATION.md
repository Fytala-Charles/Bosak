...
> **QT3 baseline (strict error codes):** **31,134 passed / 8 failed / 679 skipped** (97.84%); the 8 residuals are the documented XPST0051 schema-type validation gaps (REQ-082).
