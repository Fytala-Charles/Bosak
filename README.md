...
- **XQuery 3.1 (Phase 2 complete)** — `order by`, `count`, `group by`, and `window` clauses implemented with tuple-based VM lowering; QT3 wired (22,947/0); constructors and modules remain
...
| **XQuery** | `Bosak.XQuery` | `XQueryCompiler`, `XQueryExecutable`, `XQueryParser`, `XQueryStaticContext`; Phase 2 complete (all core FLWOR clauses); QT3 wired (22,947/0) |
