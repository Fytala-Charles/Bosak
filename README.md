...
[![XSLT 3.0 conformance](https://img.shields.io/badge/XSLT%203.0%20conformance-96.7%25-2F4F4F)](docs/ARCHITECTURE.md)
...
| Pass Rate (XSLT) | **9,929 passed / 344 failed / 4,327 skipped** (96.7%, 2026-09-17, streaming sets live since Streaming Phase C) — failures triaged: ~143 runtime forward-only streaming gaps (Phase D engine work), schema-gated XTSE1650 cases, standalone `use-when` positives, upstream artifacts; see REQ-086 decision log |
