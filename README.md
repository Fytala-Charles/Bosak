...
| Pass Rate (XSLT) | **99.8% runnable** (5,595 passed / 10 failed / 8,995 skipped) |
| Unsupported Features | Schema awareness, XQuery-only, XML 1.1, streaming, higher-order functions |
