...
[![XSLT 3.0 conformance](https://img.shields.io/badge/XSLT%203.0%20conformance-99.3%25-2F4F4F)](docs/ARCHITECTURE.md)
...
| Pass Rate (XSLT) | **10,198 passed / 77 failed / 4,325 skipped** (99.3%, 2026-09-21, streaming Phases A–D live + si-fork residual batch + provider batch + use-when batch + su-filter/su-unclassified analyzer batch) — failures triaged: schema-gated XTSE1650 (~24), assorted documented singles; see REQ-086/REQ-087/REQ-088/REQ-089/REQ-090 decision logs |
