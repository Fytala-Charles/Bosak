...
public sealed class IrLowerer
{
    ...
    private int LowerBinary(BinaryExpressionNode node, int? targetReg)
    {
        ...
        var opcode = node.Operator switch
        {
            ...
            BinaryOperator.Equal => IrOpCode.ValueEqual,
            BinaryOperator.NotEqual => IrOpCode.ValueNotEqual,
            BinaryOperator.LessThan => IrOpCode.ValueLessThan,
            BinaryOperator.LessThanOrEqual => IrOpCode.ValueLessThanOrEqual,
            BinaryOperator.GreaterThan => IrOpCode.ValueGreaterThan,
            BinaryOperator.GreaterThanOrEqual => IrOpCode.ValueGreaterThanOrEqual,
